(() => {
  ...
  // Step 2: search the whole document. The equity + discipline cards may
  // start on Trading and must be relocated into #ob-journal-equity-discipline-row.
  ...
  function moveJournalCards() {
    ...
    if (!equity || !discipline || !row) return;
